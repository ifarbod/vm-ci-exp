...
extern "C" long sys_write(int fd, const void* buf, unsigned long count)
{
    ...
    asm volatile("movq %1, %%rdi\n\t"
                 ...
                 "syscall"
        : "=a"(ret)
        : "g"(static_cast<long>(fd)), "g"(buf), "g"(count), "i"(SYS_WRITE)
...
void sys_exit(int code)
{
    asm volatile("movq %0, %%rdi\n\t"
                 ...
                 "syscall"
        :
        : "g"(static_cast<long>(code)), "i"(SYS_EXIT)
        : "rdi", "memory");
...
extern "C" long sys_write(int fd, const void* buf, unsigned long count)
{
    ...
    register long x16 asm("x16") = SYS_WRITE;
...
void sys_exit(int code)
{
    ...
    register long x16 asm("x16") = SYS_EXIT;
