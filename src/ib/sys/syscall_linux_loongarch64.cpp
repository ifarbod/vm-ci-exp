...
// Linux/LoongArch64: write=64, exit=93, mmap=222.

export module ib.sys:syscall_linux_loongarch64;
...
auto syscall6(usize n, usize a1, usize a2, usize a3, usize a4, usize a5, usize a6) -> isize
{
    ...
    __asm__ volatile("syscall 0" : "+r"(a0) : "r"(a1r), "r"(a2r), "r"(a3r), "r"(a4r), "r"(a5r), "r"(a7) : "memory");
