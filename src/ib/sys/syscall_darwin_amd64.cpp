...
// macOS/amd64 raw syscall primitive. macOS's mmap takes a padding argument
// between fd and offset, so syscall7 is provided.

export module ib.sys:syscall_darwin_amd64;
